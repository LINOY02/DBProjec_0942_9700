...
prompt Created by linoy on Thursday, June 13, 2024
set feedback off
set define off
...
insert into EMPLOYES (position, e_id, name)
values ('Counter Clerk', 785, 'Noga-Shir');
insert into EMPLOYES (position, e_id, name)
values ('Counter Clerk', 75, 'Noga-Shir');
insert into EMPLOYES (position, e_id, name)
values ('Driver', 15, ' Noa-Sir');
insert into EMPLOYES (position, e_id, name)
values ('Driver', 155, ' Noa-Sir');
insert into EMPLOYES (position, e_id, name)
values ('Driver', 125, ' Amir-Lev');
insert into EMPLOYES (position, e_id, name)
values ('Counter Clerk', 725, 'Noga-Shir');
insert into EMPLOYES (position, e_id, name)
